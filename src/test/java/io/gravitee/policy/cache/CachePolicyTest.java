...
public class CachePolicyTest {
    ...
    public void shouldUseCacheOnGETByDefault() {
        ...
        verify(executionContext, times(1)).setAttribute(eq(ExecutionContext.ATTR_INVOKER), any(CachePolicy.CacheInvoker.class));
    }
    ...
    public void shouldNotUseCacheOnPOSTByDefault() {
        ...
        verify(policyChain, times(1)).doNext(any(), any());
        verify(policyChain, never()).failWith(any());
        verify(executionContext, never()).setAttribute(eq(ExecutionContext.ATTR_INVOKER), any(CachePolicy.CacheInvoker.class));
    }
