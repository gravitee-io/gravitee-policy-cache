...
public class DummyCacheResource extends CacheResource {
    ...
    public static void replaceFirstEntryValueWith(Object value) {
        DummyCache dummy = (DummyCache) getDummyCacheInstance();
        Object firstKey = dummy.map.keySet().iterator().next();
        dummy.map.put(
            firstKey,
            new Element() {
                @Override
